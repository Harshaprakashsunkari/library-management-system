...
public class ValidationAdminStudent {
	public boolean validatedId(int id) throws ValidationException {
		...
		if (Pattern.matches(idRegEx, String.valueOf(id))) {
			...
			throw new ValidationException("Id should contains exactly 2 digits");
		}
		return result;
	}
	...
	public boolean validatedMobile(String mobile) throws ValidationException {
		...
		if (matcher.matches()) {
			...
			throw new ValidationException("Mobile Number  will start between  6 & 9 and It should contains 10 numbers ");
		}
		return result;
	}
